...
import com.univ_amu.localizcci.databinding.SpotDescriptionBindingImpl;
...
public class DataBinderMapperImpl extends DataBinderMapper {
  ...
  private static final int LAYOUT_SPOTDESCRIPTION = 7;

  private static final int LAYOUT_SPOTITEM = 8;
  ...
  static {
    ...
    INTERNAL_LAYOUT_ID_LOOKUP.put(com.univ_amu.localizcci.R.layout.spot_description, LAYOUT_SPOTDESCRIPTION);
  ...
  public ViewDataBinding getDataBinder(DataBindingComponent component, View view, int layoutId) {
    ...
    if(localizedLayoutId > 0) {
      ...
      switch(localizedLayoutId) {
        ...
        case  LAYOUT_SPOTDESCRIPTION: {
          if ("layout/spot_description_0".equals(tag)) {
            return new SpotDescriptionBindingImpl(component, new View[]{view});
          }
          throw new IllegalArgumentException("The tag for spot_description is invalid. Received: " + tag);
        }
  ...
  public ViewDataBinding getDataBinder(DataBindingComponent component, View[] views, int layoutId) {
    ...
    if(localizedLayoutId > 0) {
      ...
      switch(localizedLayoutId) {
        case LAYOUT_SPOTDESCRIPTION: {
          if("layout/spot_description_0".equals(tag)) {
            return new SpotDescriptionBindingImpl(component, views);
          }
          throw new IllegalArgumentException("The tag for spot_description is invalid. Received: " + tag);
        }
      }
  ...
  private static class InnerLayoutIdLookup {
    ...
    static {
      ...
      sKeys.put("layout/spot_description_0", com.univ_amu.localizcci.R.layout.spot_description);
